  ...
  >
    <div
      sx={{
        ...
        borderRadius: '50%',
        border: (t) =>
          isDark && t.colors ? `4px solid ${t.colors.toggleIcon}` : 'none',
        ...
        '&:before': {
          ...
          width: '24px',
          border: (t) =>
            isDark && t.colors ? `2px solid ${t.colors.toggleIcon}` : 'none',
          borderRadius: '50%',
        ...
        '&:after': {
          ...
          boxShadow: (t) =>
            t.colors
              ...
              : `0 -23px 0 #2D3748, 0 23px 0 #2D3748, 23px 0 0 #2D3748, -23px 0 0 #2D3748, 15px 15px 0 #2D3748, -15px 15px 0 #2D3748, 15px -15px 0 #2D3748, -15px -15px 0 #2D3748`,
